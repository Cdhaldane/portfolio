...
/**
 * Mirror of topRoundedBar for bars hanging BELOW a zero baseline (diverging
 * charts): square top edge on the baseline, 4px rounded data-end at the
 * bottom. (x, y) is the top-left corner as usual.
 */
export const bottomRoundedBar = (x, y, w, h) => {
  const r = Math.min(4, h, w / 2);
  const yb = y + h;
